...
schema1$gdp$vars$start <- schema(outcomes, "gdp_2010", "GDP ($thousands)", format="doll0", startYear=2010)
schema1$gdp$vars$end <- schema(outcomes, "gdp_2016", "GDP ($thousands)", format="doll0", startYear=2016)
