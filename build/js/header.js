...
export default function header(container){
    ...
    var place_swatch = swatch_group1.append("div").classed("legend-swatch",true);
        place_swatch.append("svg").attr("height","18px").attr("width","15px").style("display","inline-block")
    ...
    var nhl_swatch_svg = nhl_swatch.append("svg").attr("height","18px").attr("width","15px").style("display","inline-block")
